  ...
  return (
    <>
      <li>
        <Link
          href={`/${id}`}
          className="card group relative flex max-lg:justify-start items-center lg:flex-col max-lg:gap-5 rounded-rounded overflow-hidden bg-body-secondary group px-6 py-6"
        >
          <span className="rank group-hover:bg-primary duration-300 group-hover:text-white z-10 absolute top-4 inset-x-4 rounded-full size-7 grid place-items-center bg-body text-body-third">
            {rank}
          </span>
