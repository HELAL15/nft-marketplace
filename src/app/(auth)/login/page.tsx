    ...
    <main className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
      <Image
        ...
        <div className="content max-md:px-4 py-6">
          <h1 className=" text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold">login your account</h1>
          ...
          <FormContainer >
            ...
            <p className="text-center"><span>dont have and account? </span><Link className="text-primary underline" href="/signup">create account</Link></p>
